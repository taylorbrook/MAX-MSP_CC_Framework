        ...
        "boxes": [
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 20.0, 556.0, 1340.0, 64.0 ],
                    "rounded": 6
                }
            },
            {
                "box": {
                    ...
                    "text": "BARNETT DBAP  v0.3   two sources -> 8 ch   (A mono, B stereo)",
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 30.0, 120.0, 660.0, 500.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 20.0, 40.0, 660.0, 500.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 720.0, 120.0, 660.0, 500.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 700.0, 40.0, 660.0, 500.0 ],
                    "varname": "dbap-source",
                    "viewvisibility": 1
                }
            },
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 220.0, 722.0, 303.0, 19.0 ],
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 1429.5, 48.0, 1398.0, 48.0, 1398.0, 464.0, 1398.0, 112.0, 698.0, 112.0, 698.0, 628.0, 698.0, 112.0, 712.0, 112.0, 712.0, 628.0, 712.0, 714.0, 531.0, 714.0, 531.0, 749.0, 39.5, 749.0 ],
                    "source": [ "obj-25", 0 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-11", 0 ],
                    "midpoints": [ 39.5, 714.0, 212.0, 714.0, 212.0, 749.0, 39.5, 749.0 ],
                    "source": [ "obj-6", 0 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-11", 0 ],
                    "midpoints": [ 729.5, 112.0, 698.0, 112.0, 698.0, 628.0, 698.0, 714.0, 531.0, 714.0, 531.0, 749.0, 39.5, 749.0 ],
                    "source": [ "obj-7", 0 ]
                }
            },
            {
