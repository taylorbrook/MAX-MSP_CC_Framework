        ...
        "boxes": [
            {
                "box": {
                    ...
                    "text": "terrain-osc-b v0.4 (slot B twin of terrain-osc.maxpat -- keep the codebox in sync)  --  live wave-terrain oscillator, one gen~ codebox reading buffer~ terrainbufB (256x256 row-major)",
                    "fontname": "Arial",
                    "fontsize": 13.0,
                    "textcolor": [
                        0.2,
