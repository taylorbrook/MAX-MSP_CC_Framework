...
- [x] **Phase 3: Code Generation** - Gen~ GenExpr, js/V8, and Node for Max code generation with syntax validation (completed 2026-03-10)
...
- [x] **Phase 5: RNBO and External Development** - RNBO-compatible patch generation with export awareness and C/C++ external scaffolding via Min-DevKit (completed 2026-03-10)
...
- [x] **Phase 7: Fix Stale Agent Documentation** - Remove stale "stub" labels and clarify RNBO validation scope in agent documentation files (gap closure from v1.0 audit, completed 2026-03-10)
...
Plans:
- [x] 03-01-PLAN.md -- GenExpr code builder, gen~ codebox embedding in .maxpat, standalone .gendsp generation
- [x] 03-02-PLAN.md -- N4M and js code generation, code validation (GenExpr/js/N4M), hook extension for .gendsp/.js
...
Plans:
- [x] 04-01-PLAN.md -- DSP and structure critic Python modules extending validation pipeline
- [x] 04-02-PLAN.md -- Persistent memory system with dual-scope storage and deduplication
- [x] 04-03-PLAN.md -- Project lifecycle infrastructure with directory isolation, status tracking, and test protocol
- [x] 04-04-PLAN.md -- Router and specialist agent skill definitions (router + 6 specialists)
- [x] 04-05-PLAN.md -- Critic, memory, and lifecycle agent skills plus validation tests
- [x] 04-06-PLAN.md -- Slash commands for project lifecycle (10 commands)
...
- [x] 05-03-PLAN.md -- External build system (cmake/make invocation, auto-fix loop, .mxo validation)
- [x] 05-04-PLAN.md -- Critics, agent upgrades, and public API integration (RNBO/ext critics, stub-to-full agents)
...
Plans:
- [x] 07-01-PLAN.md — TDD regression tests + fix stale stub labels in max-build.md, dispatch-rules.md, and RNBO SKILL.md
...
| 3. Code Generation | 2/2 | Complete | 2026-03-10 |
| 4. Agent System and Orchestration | 6/6 | Complete | 2026-03-10 |
| 5. RNBO and External Development | 4/4 | Complete | 2026-03-10 |
| 6. Fix Skill Documentation Signatures | 1/1 | Complete | 2026-03-10 |
| 7. Fix Stale Agent Documentation | 1/1 | Complete | 2026-03-10 |

---
*Roadmap created: 2026-03-08*
*Last updated: 2026-03-10 (all 7 phases complete — milestone v1.0 audit passed)*
