...
Last activity: 2026-09-21 - Completed quick task 260921-knq: NH-01 closed — `tools/audit_db.py` (7-section read-only DB-vs-installed-Max audit, JSON + text, ~1.3s) + 33 hermetic tests. Real run: Max 9.1.5, DB 82d old, 7 unresolved refpage names, 0 unresolved patch objects, 1 maxclass gap (`gen~` test fixture, DEF-knq-01). Suite 2201 → 2234 passed
